              ...
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <tbody>
                    ...
                    <tr>
                      <th class="text-center text-uppercase text-secondary text-sm font-weight-bolder">Status Kurir</th>
                      <td class="align-middle text-center text-sm">
                        @if($data->kurir_antar == 1 && $data->kurir_jemput == 1)
                            <span class="text-secondary text-sm font-weight-bold">Kurir Antar dan Kurir Jemput</span>
                        @elseif($data->kurir_antar == 1 && $data->kurir_jemput == 0)
                            <span class="text-secondary text-sm font-weight-bold">Kurir Antar</span>
                        @else
                            <span class="text-secondary text-sm font-weight-bold">Kurir Jemput</span>
                        @endif
                      </td>              
                    </tr>
                    <tr>
