...
@section('container')
    ...
    <div class="col-md-8">
        <main class="form-registration">
            <h1 class="h3 my-3 fw-normal text-center">Form Tambah Agen</h1>
        <form action="/dashboard/admin/createAgen" method="post">
            @csrf
           ...
           <input type="hidden" id="agen" name="agen" value="1">
            ...
            <button type="submit" class="btn bg-gradient-primary">Tambah Agen</button>
        </form>
        </main>
    </div>
</div>
